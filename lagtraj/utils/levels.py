...
def make_exponential_levels(dz_min,top,n_levels):
    level_rate=ridder(exponential_levels_error,1.000000000000001,2.0,args=(dz_min,top,n_levels))
    level_list=[0.0]
    for level in range(1,n_levels):
        level_list=level_list+[dz_min*((1.0-level_rate**level)/(1.0-level_rate))]
