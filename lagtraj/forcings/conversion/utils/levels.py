...
ConversionLevelsDefinition = namedtuple(
    "ConversionLevelsDefinition", ["method", "n_levels", "z_top", "dz_min"]
)


def make_levels(method, n_levels=None, z_top=None, dz_min=None):
    if method == "linear":
