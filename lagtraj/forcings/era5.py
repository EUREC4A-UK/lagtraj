...
def get_from_yaml(input_file,directories_file):
    ...
    trajectory_file=trajectory_filename_parse(directories_dict,forcings_dict['trajectory'])
...
def append_timestep(forcings_dict,forcing_data,trajectory_data,timestep):
    ...
    lon_indices,lat_indices=calculate_current_lat_lon_range(forcings_dict,trajectory_data,timestep)
    timestep_input_data=xr.Dataset()
    append_single_level_an(timestep_input_data,trajectory_data,timestep,lon_indices,lat_indices)
    append_single_level_fc(timestep_input_data,trajectory_data,timestep,lon_indices,lat_indices)
    append_model_level_an(timestep_input_data,trajectory_data,timestep,lon_indices,lat_indices)
    append_model_level_fc(timestep_input_data,trajectory_data,timestep,lon_indices,lat_indices)
    add_heights_and_pressures(timestep_input_data)
    timestep_interpolated_data=interpolate_to_height_levels(timestep_input_data)
    timestep_forcing_data=calculate_forcings(forcings_dict,timestep_interpolated_data)
...
def append_single_level_an(timestep_input_data,trajectory_data,timestep,lon_indices,lat_indices):
    pass
    
def append_single_level_fc(timestep_input_data,trajectory_data,timestep,lon_indices,lat_indices):
    pass
      
def append_model_level_an(timestep_input_data,trajectory_data,timestep,lon_indices,lat_indices):
    pass
      
def append_model_level_fc(timestep_input_data,trajectory_data,timestep,lon_indices,lat_indices):
    pass
